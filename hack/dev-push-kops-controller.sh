...
# Keep the build tags in sync with BUILDTAGS in the Makefile.
KO_DOCKER_REPO="${IMAGE_PREFIX}kops-controller" GOFLAGS="-tags=disable_grpc_modules,grpcnotrace" go run github.com/google/ko@v0.18.0 \
