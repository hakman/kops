...
resource "azurerm_network_security_group" "minimal-azure-example-com" {
  ...
  security_rule {
    ...
    priority                                   = 2000
    protocol                                   = "Tcp"
    source_address_prefixes                    = ["0.0.0.0/0", azurerm_public_ip.minimal-azure-example-com.ip_address]
    source_port_range                          = "*"
  }
  security_rule {
    access                                     = "Allow"
    ...
    priority                                   = 2001
    protocol                                   = "Tcp"
    source_address_prefixes                    = [azurerm_public_ip.minimal-azure-example-com.ip_address]
    source_port_range                          = "*"
  }
  security_rule {
    access                     = "Allow"
