...
// stubChannelsManifest is the pre-baked pod YAML the test seeds into VFS.
// Real content is exercised by the cloudup ChannelsBuilder tests.
...
// TestReadChannelsManifest_SELinux asserts the parse/decorate/reserialize
// branch toggles correctly on ContainerdConfig.SeLinuxEnabled: ON adds the
// permissive context, OFF leaves it untouched.
